...
export function Dashboard() {
  ...
  return (
    <div className="flex h-screen flex-col bg-background text-foreground">
      <header className="flex items-center justify-between border-b border-dashed px-4 py-3">
        ...
        <div className="flex items-center gap-3">
          <SearchBar />
          <Button variant="ghost" size="sm" className="label-caps" onClick={() => logout().then(() => window.location.reload())}>
            Log out
          </Button>
        </div>
      </header>
